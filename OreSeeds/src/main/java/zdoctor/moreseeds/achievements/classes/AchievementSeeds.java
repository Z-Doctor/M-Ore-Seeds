package zdoctor.moreseeds.achievements.classes;

public class AchievementSeeds {
//	public static Achievement GetWitherSkull = new Achievement("", "GetWitherSkull", 0, 0, new ItemStack(Items.skull, 1, 1), (Achievement)null).initIndependentStat();
...
//	
//	public static Achievement GetStrawberry = new Achievement("", "GetStrawberry", -1, 0, ZItems.Strawberry, (Achievement) null).initIndependentStat();
//			
